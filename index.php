		...
		if ($post) {
			while ($result = $post->fetch_assoc()) { ?>
				<div class="samepost clear">
					<h2><a href="post.php?post_id=<?php echo $result['id']; ?>"><?php echo $result['title']; ?></a></h2>
					<h4><?php echo $fm->formateDate($result['date']); ?>, By <a href="#"><?php echo $result['author']; ?></a></h4>
					<a href="#"><img src="admin/<?php echo $result['image']; ?>" /></a>
					<?php
					echo $fm->textShorten($result['body']); ?>
					<div class="readmore clear">
						<a href="post.php?post_id=<?php echo $result['id']; ?>">Read More</a>
					</div>
				</div>
			<?php } // end while loop 
			?>
