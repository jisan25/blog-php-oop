        ...
        if ($post) {
            while ($result = $post->fetch_assoc()) { ?>
                <div class="popular clear">
                    <h3><a href="post.php?post_id=<?php echo $result['id']; ?>"><?php echo $result['title']; ?></a></h3>
                    <a href="post.php?post_id=<?php echo $result['id']; ?>"><img src="admin/<?php echo $result['image']; ?>" /></a>
